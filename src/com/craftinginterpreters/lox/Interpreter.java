...
public class Interpreter implements Expr.Visitor<Object>, 
  ...
  public Object visitTernaryExpr(Expr.Ternary expr) {
    boolean test = isTruthy(evaluate(expr.expr));

    if (test) return evaluate(expr.ifTrue);
  ...
  public Object visitLogicalExpr(Expr.Logical expr) {
    ...
    if (isTruthy(left) && expr.operator.type == OR) {
      return left;
    } else if (!isTruthy(left) && expr.operator.type == AND) {
      return left;
    }
  ...
  public Object visitCallExpr(Expr.Call expr) {
    ...
    for (Expr exprArgument : expr.arguments) {
      arguments.add(evaluate(exprArgument));
    }
